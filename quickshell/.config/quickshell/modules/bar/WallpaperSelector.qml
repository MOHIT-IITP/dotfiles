...
// Wallpaper selector coverflow modal modeled after reference screenshot
Rectangle {
  id: root

  readonly property bool open: WallpaperState.open
      ...
      PathView {
        ...
        delegate: Item {
          ...
          Rectangle {
            ...
            color: "#cc0c0e0c"
            visible: isCur
            border.color: isApplying ? "#f2c14e" : "#2a322a"
            border.width: 1
